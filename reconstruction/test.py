...
if __name__=="__main__":
    ...
    net = transnet().cuda()
    net.load_state_dict(torch.load('/content/CNS-GAN/reconstruction/model/deconvNN_par.pkl'))
...
#           testdata_y.append(train_y[train_id[i]])
    ...
    test_img_path = '/content/CNS-GAN/tmp/test_pix2pix/'
    ...
    for i in range (len(testdata_x)):
        ...
        img.save(os.path.join(file_path, test_id[i]+ '.JPEG'))
